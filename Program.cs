...
if (age > keschasAge)
{
    System.Console.WriteLine("Yor are older!");
}
else if(ageDifference == keschasAge)
{
    System.Console.WriteLine("Your are equal");
}
else
{
    System.Console.WriteLine("Your are younger!");
}